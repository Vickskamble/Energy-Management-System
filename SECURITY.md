...
| **`seed_data.ps1`** | ⚠️ **CRITICAL GAP** — git-tracked with real URL + anon key + demo account `demo@powerems.com` / `demo1234` (`seed_data.ps1:6-7, 30-31`) |

**Recommended actions:**
1. **Delete the `demo@powerems.com` account** from the production Supabase project immediately.
